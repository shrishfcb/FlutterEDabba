...
String uid;
class MenuDNVeg extends StatefulWidget {
  @override
...
class _MenuPageState extends State<MenuDNVeg> {
  int currentValue=0;
  int currentValue2=0;
  int currentValue3=0;
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text('Select Your Chicken Dish:', style: TextStyle(fontFamily: 'Raleway' ,fontSize: 25.0,)),
                    ),
                    Row (
                      children: <Widget>[
                        Padding(
                    ...
                    Padding(
                      ...
                      child: Text('Today\'s other dishes: ${bp1} and ${bp2}, along with papad and salad ' , style: TextStyle(fontFamily: 'Raleway' ,fontSize: 20.0,),),
                    ),
                    Padding(
